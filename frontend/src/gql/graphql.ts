...
export type GetMyConversationsQuery = { __typename?: 'Query', getMyConversations: Array<{ __typename?: 'ConversationModel', id: string, title: string, createdAt: any, users: Array<{ __typename?: 'UserModel', id: string, username: string, email: string }>, messages: Array<{ __typename?: 'MessageModel', id: string, content: string, createdAt: any, user: { __typename?: 'UserModel', id: string, username: string } }> }> };
